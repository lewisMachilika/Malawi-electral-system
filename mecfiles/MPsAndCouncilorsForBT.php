...
<html>
	...
	<body>
		<table border="0">
			<thead>
				<th colspan="5">MPs and councilors for blantyre city</th>
			</thead>
			<tbody>
				<?php
	...
	position_name AS position, represent, (SELECT COUNT(candidate_id)
	 ...
	 FROM 
	citizen c, candidate k WHERE c.citizen_id = k.citizen_id AND 
	position_name IN('MP','councilor') AND (represent IN
	...
	(SELECT ward_name FROM ward WHERE constituency_name IN('Blantyre-City-central','Blantyre-City-east')))
