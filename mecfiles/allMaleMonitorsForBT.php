...
#back{
	...
	<body>
		<table border="0">
			<thead>
				<th colspan="5">all male monitors for blantyre</th>
			</thead>
			<tbody>
				<?php
...
WHERE citizen.citizen_id= monitor.citizen_id AND citizen.sex='M' AND citizen.citizen_id IN (SELECT citizen_id 
