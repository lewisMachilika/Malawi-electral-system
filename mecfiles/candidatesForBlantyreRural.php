...
<html>
	...
	<body>
		<table border="0">
			<thead>
				<th colspan="5">MPs, councilors and presidents for blantyre rural</th>
			</thead>
			<tbody>
				<?php
	...
	( SELECT constituency_name FROM constituency WHERE 
		constituency_name =('Blantyre-rural')) OR represent IN
	(SELECT ward_name FROM ward WHERE constituency_name =('Blantyre-rural'))) OR represent=('Malawi'))
